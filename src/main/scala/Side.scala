...
case object KingSide extends Side {
  ...
  val tripToRook: (Pos, Board) => List[Pos] = (pos, board) => pos moveRight board.pieces.contains
}
case object QueenSide extends Side {
  ...
  val tripToRook: (Pos, Board) => List[Pos] = (pos, board) => pos moveLeft board.pieces.contains
}
